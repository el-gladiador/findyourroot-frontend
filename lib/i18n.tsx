...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'settings.editorCanEdit': 'Editor (Can edit)',
  ...
  de: {
    ...
    'settings.editorCanEdit': 'Editor (Kann bearbeiten)',
  ...
  fa: {
    ...
    'settings.coAdminCanApprove': 'معاون مدیر (می‌تواند تأیید کند)',
    'settings.editorCanEdit': 'ویرایشگر (می‌تواند ویرایش کند)',
